...
created_at = Annotated[datetime, mapped_column(DateTime(timezone=True), default=datetime.now(tz=timezone.utc))]
updated_at = Annotated[datetime, mapped_column(DateTime(timezone=True), default=datetime.now(tz=timezone.utc), onupdate=datetime.now(tz=timezone.utc))]
