...
ChatPermissionsRepositoryDep = Annotated[BaseChatPermissionsRepository, Depends(get_chat_permissions_repo)]
...
async def check_send_permission(
    ...
    permissions = await chat_permissions_repo.get_user_chat_permissions(chat_id=chat_id, user_id=current_member.id)
...
RemoveMembersPermissionDep = Annotated[ChatPermissions, Depends(check_remove_members_permission)]
...
DeleteMessagesPermissionDep = Annotated[ChatPermissions, Depends(check_delete_messages_permission)]
